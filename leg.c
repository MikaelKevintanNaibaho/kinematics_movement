...
void initialize_all_legs() {
    ...
    initialize_leg(&leg_kiri_depan, "Kiri Depan", SERVO_CHANNEL_1, SERVO_CHANNEL_2, SERVO_CHANNEL_3);
    initialize_leg(&leg_kiri_belakang, "Kiri Belakang", SERVO_CHANNEL_4, SERVO_CHANNEL_5, SERVO_CHANNEL_6);
    initialize_leg(&leg_kanan_belakang, "Kanan Belakang", SERVO_CHANNEL_7, SERVO_CHANNEL_8, SERVO_CHANNEL_9);
    initialize_leg(&leg_kanan_depan, "Kanan Depan", SERVO_CHANNEL_10, SERVO_CHANNEL_11, SERVO_CHANNEL_12);
