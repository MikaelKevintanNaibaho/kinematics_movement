...
#define MIN_DUTY_CYCLE 5   // Duty cycle for 0 degrees (approx. 500μs pulse width at 1000Hz)
#define MAX_DUTY_CYCLE 25  // Duty cycle for 180 degrees (approx. 2500μs pulse width at 1000Hz)
